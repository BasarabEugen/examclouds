...
public class MainFruit {
    public static void main(String[] args) {
        ...
        System.out.print("Total cost of sold fruit: ");
        System.out.println((apple1.getCostApple() * apple1.getWeight())
                + (pear1.getCostPear() * pear1.getWeight())
                + (apricot1.getCostApricot() * apricot1.getWeight()));
    }
}
